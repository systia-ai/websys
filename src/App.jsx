...
const modules = [
  ...
  { key: 'reparaciones', title: 'Orden de servicio', table: 'reparaciones', fields: ['equipo_id', 'cliente_id', 'tecnico', 'estatus', 'descripcion_equipo', 'problemas_reportados', 'niveles_tinta', 'descripcion_solucion', 'bitacora', 'pago', 'costo_reparacion', 'tipo_reparacion'] },
]
